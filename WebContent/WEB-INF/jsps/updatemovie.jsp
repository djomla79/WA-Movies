...
<body>
	...
	<div class="well">Enter movie's data</div>

	<div class="container">
		<div class="container1">

			<sf:form action="${pageContext.request.contextPath}/updatingmovie"
				method="post" modelAttribute="movie">

				<div class="row">

					<label>Name: </label><br/>
					<sf:input type="text" path="name" name="name" placeholder="${movie.name}" title="Please, enter a name of the movie." />
					<br/><sf:errors path="name" cssClass="error"></sf:errors>
					<br/> <label>Year: </label><br/>
					<sf:input type="text" path="year" name="year" placeholder="${movie.year}" />
					<br/><sf:errors path="year" cssClass="error"></sf:errors>
					<br/><label>Genre: </label><br/>
					<sf:input type="text" path="genre" name="genre" placeholder="${movie.genre}" />
					<br/><sf:errors path="genre" cssClass="error"></sf:errors>
					<br/><label>Director: </label><br/>
					<sf:input type="text" path="director" name="director" placeholder="${movie.director}" />
					<br/><sf:errors path="director" cssClass="error"></sf:errors>
					<br/><label>Runtime: </label><br/>
					<sf:input type="text" path="runtime" name="runtime" placeholder="${movie.runtime}" />
