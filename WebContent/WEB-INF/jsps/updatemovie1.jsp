...
<head>
	...
	<title>Update movie by name</title>
</head>
<body>
    ...
    <div class="container" >
      ...
      <form action="${pageContext.request.contextPath}/updatingmovie1" method="post">
      
          <div class="row">Enter a name of the movie<br />
          <input type="text" name="name" placeholder="Movie name"></div><br />
